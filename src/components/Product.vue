...
<div>
  ...
  <div class="top">
    ...
    <div class="i_car">
      <router-link to="/buycart"><div class="car_t">购物车 [ <span>3</span> ]</div></router-link>
      <div class="car_bg">
        <!--Begin 购物车未登录 Begin-->
  ...
  <div class="i_bg">
    ...
    <div class="content">
      ...
      <div class="pro_des">
        ...
        <div class="des_price">
          <span v-for="prices in price">
          本店价格：<b>￥{{prices.price}}</b><br />
          </span>
          消费积分：<span>28R</span>
        </div>
        <div class="des_choice" v-for="( value,key) in goods.data" >
          <span class="fl">{{key}}：</span>
          <label>
            <span v-for="value1 in value">
            <input  @click="get_id"  type="radio" v-bind:id="value1[0]" v-bind:value="value1[1]" v-bind:name="key" >{{value1[0]}}
              </span>
          </label>
        </div>
        ...
        methods: {
            get_id (){
                ...
                // console.log(this.goods.data)
                 var _this=this
                 $.each(this.goods.data, function (key,val) {
                ...
                // console.log(this.isajax)
                 if (this.isajax==1){
                     $.each(this.goods.data,function (keys,value) {
            ...
            cat (){
                var _this=this
                var  attr_name=''
                $.each(this.goods.data,function (k,v) {
